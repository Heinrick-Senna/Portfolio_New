window.onload = function () {
	$('#FloatTheme li').click(function(){
		clickTheme=$(this).attr('id').replace(/[^0-9]/g,'');
		Theme(clickTheme);
	})
}

function Theme (){
		var actualTheme = 0 + parseInt(actualTheme, 10);
		alert(actualTheme);
		ThemeSwitch(clickTheme, verifyTheme = actualTheme);
	}

function ThemeSwitch (verifyTheme=actualTheme) {
